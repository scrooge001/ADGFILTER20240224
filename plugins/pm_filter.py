...
async def next_page(bot, query):
    ...
    if int(req) not in [query.from_user.id, 0]:
        return await query.answer("scroogex", show_alert=True)
    try:
        offset = int(offset)
    except:
        offset = 0
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('👨‍💻𝓐𝓓𝓖 𝓜𝓞𝓥𝓘𝓔𝓢👩‍💻')
            else:
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Check PM, Movie Filter sent files in PM', show_alert=True)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 𝓐𝓓𝓖 𝓜𝓞𝓥𝓘𝓔𝓢 🤖', url='https://t.me/adgmovies')
            ],[
            InlineKeyboardButton('🔰 FILM GROUP 🔰', url='https://t.me/adgmovies'),
            InlineKeyboardButton('♨️ MOVIES ♨️', url='https://t.me/adgmovies')
            ],[
            InlineKeyboardButton('😇 MORE 😇', callback_data='help'),
            InlineKeyboardButton('📛 ABOUT 📛', callback_data='about')
            ],[
            InlineKeyboardButton('🍭 𝓣𝓔𝓐𝓜 𝓐𝓓𝓖 🍭', url='https://t.me/+p5l-3z_6yXdlMjQ9')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
